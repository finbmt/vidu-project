...
<head>
	...
	<link href="public/user/css/main_user.css" rel="stylesheet">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="public/img/home/logo.png" alt="" /></a>
						</div>
					</div>
					<div class="col-sm-8">
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="index.html" class="active">Trang chur</a></li>
								<li class="dropdown"><a href="#">San pham</a></li> 
